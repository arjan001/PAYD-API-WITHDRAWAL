...
- [DB SSL strategy](db-ssl-strategy.md) — no connectionString; pg reads PG* env vars; ssl: false in dev, ssl:{rejectUnauthorized:false} in prod; DATABASE_URL is runtime-managed, never set as secret
